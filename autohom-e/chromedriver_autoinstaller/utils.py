# coding: utf-8
"""
The underlying code has been used legally according to MIT license.
The sole author of the code is GitHub user yeongbin-jo.
Source of the code is: https://github.com/yeongbin-jo/python-chromedriver-autoinstaller
"""
...
def download_chromedriver(path: str = None):
    ...
    if path:
        ...
        chromedriver_dir = os.path.abspath('.')
